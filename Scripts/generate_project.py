...
for name, (files, sdk, bundle, kind, folder) in specs.items():
    ...
    info = dict(CFBundleDisplayName='オウチカエル', CFBundleExecutable='$(EXECUTABLE_NAME)', CFBundleIdentifier='$(PRODUCT_BUNDLE_IDENTIFIER)', CFBundleInfoDictionaryVersion='6.0', CFBundleName='$(PRODUCT_NAME)', CFBundlePackageType='XPC!' if kind == 'app-extension' else 'APPL', CFBundleShortVersionString='1.0.2', CFBundleVersion='6')
    if name == 'Ouchikaeru':
